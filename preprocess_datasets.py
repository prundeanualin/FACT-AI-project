...
cognitive_df_new_cols = cognitive_df[cognitive_df.columns.difference(student_df.drop(columns=merge_columns).columns)]
...
cognitive_df = cognitive_df_new_cols[[x for x in cognitive_df_new_cols if x in merge_columns or x.endswith(('C', 'S'))]]
