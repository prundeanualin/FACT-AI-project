...
# print(model.embedding_mlp_P)
# print(model.embedding_mlp_Q)
# print(model.mlp_p)
# print(model.mlp_q)
# print(model.mlp_vector)

users = [1, 2, 3]
user_input = np.array([model.user2id[x] for x in users])
...
# To actually compute and retrieve the values of 'user_emb', run it within a session
with model.sess.as_default():
    user_emb_evaluated = user_emb.eval()

print(user_emb_evaluated)
