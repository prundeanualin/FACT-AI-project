...
args.add_argument("-EPOCHS_ATTACKER", default=20, type=int)
args.add_argument("-FILTER_LAYER_SIZES", default=[32], type=list)
args.add_argument("-MODEL", default="NCF", type=str)
args.add_argument("-LR", default=0.001, type=float)
args.add_argument("-LR_DISC", default=0.01, type=float)
args.add_argument("-DISCR_LATENT", default=32, type=int)
...
for epoch in range(args.N_EPOCHS):
    ...
    for batch_data in tqdm(valid, desc=f"Epoch {epoch} - Testing (Filtered) User Model"):
        # Unpack all elements from the batch data
        user_id, item_id, rating, user_emb, movie_emb = batch_data
    ...
    print(f"Epoch {epoch} - Evaluation Results User Model (Filtered):")
    ...
    print(f"Epoch {epoch} - Evaluation Results Attackers:")
